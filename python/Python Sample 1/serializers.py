...
class ApplyLeaveSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if data.get('start_date') > data.get('end_date'):
            raise serializers.ValidationError({'end_date': _('END_DATE_SHOULD_GREATER_THAN_START')})
        ...
        if date_exists_queryset:
            ...
            raise serializers.ValidationError({'start_date': _('SELECTED_LEAVES_ARE_ALREADY_APPLIED') % dates})
